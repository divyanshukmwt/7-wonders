...
import img1 from './TajMahal1.jpg';
import img2 from './TajMahal2.jpg';
import img3 from './TajMahal3.jpg';
import audio from './Goddess of the Mountain by Winky詩 Cover 百鬼 IBUKI.mp3';

const TajMahalCanvas = () => {
  ...
  useEffect(() => {
    ...
    const currentFrame = (index) =>
      `/Images/TajMahal/Frame_${(index + 1).toString().padStart(4, "0")}.webp`;
              ...
              >
                <div ref={textWrapperRef} className="absolute w-full">
                  <h2 className="font-bold font-[montserrat] text-2xl mb-4">
                    {currentSlide === 0 && "The Timeless Taj Mahal"}
                    {currentSlide === 1 && "A Monument of Love and Devotion"}
                    {currentSlide === 2 && "An Icon of Indian Heritage"}
                  </h2>
                  <p className="mb-2 w-[95%] font-[montserrat]">
                    {currentSlide === 0 &&
                      "Located in Agra, India, the Taj Mahal is a stunning white marble mausoleum built by Emperor Shah Jahan in memory of his beloved wife Mumtaz Mahal. Its flawless symmetry and intricate designs make it an architectural masterpiece."}
                    {currentSlide === 1 &&
                      "Construction of the Taj Mahal began in 1632 and took over 20 years to complete, employing thousands of artisans, craftsmen, and laborers. The monument features exquisite carvings, inlaid gemstones, and perfectly landscaped gardens, reflecting Mughal architectural brilliance."}
                    {currentSlide === 2 &&
                      "Recognized as a UNESCO World Heritage Site, the Taj Mahal is celebrated globally as a symbol of eternal love, artistry, and India’s rich cultural heritage. Millions of visitors admire its beauty and serenity every year."}
                  </p>
                </div>
